...
static int __devinit sdhci_zynq_probe(struct platform_device *pdev)
{
	...
	pr_info("sdhci-of-zynq: SDHCI zync probe\n");

	/* Major hack here to set the pin mux register appropriately */
	/* writel(0x002F000F, 0xF8000830); */
...
{
	pr_info("sdhci-of-zynq: SDHCI zync init\n");
